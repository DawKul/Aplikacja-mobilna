...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555165, ; uint32_t android_runtime_jnienv_class_token (0x20002dd)
	i32 100670767, ; uint32_t jnienv_initialize_method_token (0x6001d2f)
	i32 100670766, ; uint32_t jnienv_registerjninatives_method_token (0x6001d2e)
...
@dso_cache = dso_local local_unnamed_addr global [558 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.27_name, ; name: libaot-Xamarin.AndroidX.Biometric.dll.so
		ptr null; void* handle (0x0)
	}, ; 7
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.90_name, ; name: libaot-mscorlib.dll.so
		ptr null; void* handle (0x0)
	}, ; 16
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 733635950719068722, ; hash 0xa2e66029d10ea32, from name: Plugin.FirebaseAuth
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Plugin.FirebaseAuth.dll.so
		ptr null; void* handle (0x0)
	}, ; 20
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.67_name, ; name: libaot-System.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 25
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.21_name, ; name: libaot-Plugin.CurrentActivity.dll.so
		ptr null; void* handle (0x0)
	}, ; 51
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-Plugin.Fingerprint.dll.so
		ptr null; void* handle (0x0)
	}, ; 64
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2444305504255866078, ; hash 0x21ebeae7d7b3f4de, from name: aot-Aplikacja Treningowa.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Aplikacja Treningowa.dll.so
		ptr null; void* handle (0x0)
	}, ; 72
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2554234501788493113, ; hash 0x237276bf18266539, from name: libaot-Plugin.FirebaseAuth.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Plugin.FirebaseAuth.dll.so
		ptr null; void* handle (0x0)
	}, ; 79
	...
	%struct.DSOCacheEntry {
		i64 5374960791989999934, ; hash 0x4a97b25cd037593e, from name: aot-Plugin.FirebaseAuth.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Plugin.FirebaseAuth.dll.so
		ptr null; void* handle (0x0)
	}, ; 161
	...
	%struct.DSOCacheEntry {
		i64 10736991851160376078, ; hash 0x950175339cad930e, from name: Aplikacja Treningowa.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Aplikacja Treningowa.dll.so
		ptr null; void* handle (0x0)
	}, ; 317
	...
	%struct.DSOCacheEntry {
		i64 12427070373678343500, ; hash 0xac75d2a9d5e0e54c, from name: aot-Aplikacja Treningowa
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Aplikacja Treningowa.dll.so
		ptr null; void* handle (0x0)
	}, ; 375
	...
	%struct.DSOCacheEntry {
		i64 12652456264956341976, ; hash 0xaf968deff8e36ed8, from name: Aplikacja Treningowa
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Aplikacja Treningowa.dll.so
		ptr null; void* handle (0x0)
	}, ; 381
	...
	%struct.DSOCacheEntry {
		i64 13244532567241561599, ; hash 0xb7ce0832868695ff, from name: libaot-Aplikacja Treningowa
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Aplikacja Treningowa.dll.so
		ptr null; void* handle (0x0)
	}, ; 402
	...
	%struct.DSOCacheEntry {
		i64 14959727337789455315, ; hash 0xcf9ba0c0f1a3fbd3, from name: libaot-Aplikacja Treningowa.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Aplikacja Treningowa.dll.so
		ptr null; void* handle (0x0)
	}, ; 459
	...
	%struct.DSOCacheEntry {
		i64 15135052372707974725, ; hash 0xd20a81f1ac311e45, from name: Plugin.FirebaseAuth.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Plugin.FirebaseAuth.dll.so
		ptr null; void* handle (0x0)
	}, ; 461
	...
	%struct.DSOCacheEntry {
		i64 16376090350818384915, ; hash 0xe3438f68ea3b5c13, from name: libaot-Plugin.FirebaseAuth
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Plugin.FirebaseAuth.dll.so
		ptr null; void* handle (0x0)
	}, ; 499
	...
	%struct.DSOCacheEntry {
		i64 16463589454951447404, ; hash 0xe47a6b61a63f7b6c, from name: aot-Plugin.FirebaseAuth
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Plugin.FirebaseAuth.dll.so
		ptr null; void* handle (0x0)
	}, ; 501
...
@.env.3 = private unnamed_addr constant [37 x i8] c"86ab759e-b100-4530-831f-5d47b8fb8d92\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [14 x i8] c"com.aplikacja\00", align 1
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [35 x i8] c"libaot-Aplikacja Treningowa.dll.so\00", align 16
...
@.DSOCacheEntry.21_name = private unnamed_addr constant [37 x i8] c"libaot-Plugin.CurrentActivity.dll.so\00", align 16
@.DSOCacheEntry.22_name = private unnamed_addr constant [33 x i8] c"libaot-Plugin.Fingerprint.dll.so\00", align 16
@.DSOCacheEntry.23_name = private unnamed_addr constant [34 x i8] c"libaot-Plugin.FirebaseAuth.dll.so\00", align 16
...
@.DSOCacheEntry.27_name = private unnamed_addr constant [41 x i8] c"libaot-Xamarin.AndroidX.Biometric.dll.so\00", align 16
...
@.DSOCacheEntry.67_name = private unnamed_addr constant [26 x i8] c"libaot-System.Core.dll.so\00", align 16
...
@.DSOCacheEntry.90_name = private unnamed_addr constant [23 x i8] c"libaot-mscorlib.dll.so\00", align 16
