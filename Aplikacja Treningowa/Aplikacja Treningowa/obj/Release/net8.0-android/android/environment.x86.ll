...
@dso_cache = dso_local local_unnamed_addr global [558 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 26166821, ; hash 0x18f4625, from name: aot-Plugin.FirebaseAuth
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 608859720, ; hash 0x244a7648, from name: Aplikacja Treningowa
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1236272057, ; hash 0x49b003b9, from name: libaot-Aplikacja Treningowa
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Aplikacja Treningowa.dll.so
		ptr null; void* handle (0x0)
	}, ; 151
	...
	%struct.DSOCacheEntry {
		i64 1315287762, ; hash 0x4e65b2d2, from name: aot-Aplikacja Treningowa.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Aplikacja Treningowa.dll.so
		ptr null; void* handle (0x0)
	}, ; 161
	...
	%struct.DSOCacheEntry {
		i64 1660234975, ; hash 0x62f52cdf, from name: Plugin.FirebaseAuth.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Plugin.FirebaseAuth.dll.so
		ptr null; void* handle (0x0)
	}, ; 213
	...
	%struct.DSOCacheEntry {
		i64 2253624722, ; hash 0x86539592, from name: aot-Aplikacja Treningowa
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Aplikacja Treningowa.dll.so
		ptr null; void* handle (0x0)
	}, ; 289
	...
	%struct.DSOCacheEntry {
		i64 2606510329, ; hash 0x9b5c30f9, from name: libaot-Plugin.FirebaseAuth
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Plugin.FirebaseAuth.dll.so
		ptr null; void* handle (0x0)
	}, ; 342
	...
	%struct.DSOCacheEntry {
		i64 3156461935, ; hash 0xbc23c96f, from name: aot-Plugin.FirebaseAuth.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Plugin.FirebaseAuth.dll.so
		ptr null; void* handle (0x0)
	}, ; 423
	%struct.DSOCacheEntry {
		i64 3164727130, ; hash 0xbca1e75a, from name: libaot-Aplikacja Treningowa.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Aplikacja Treningowa.dll.so
		ptr null; void* handle (0x0)
	}, ; 424
	...
	%struct.DSOCacheEntry {
		i64 3208410709, ; hash 0xbf3c7655, from name: Aplikacja Treningowa.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Aplikacja Treningowa.dll.so
		ptr null; void* handle (0x0)
	}, ; 428
	...
	%struct.DSOCacheEntry {
		i64 4006362763, ; hash 0xeecc3e8b, from name: libaot-Plugin.FirebaseAuth.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Plugin.FirebaseAuth.dll.so
		ptr null; void* handle (0x0)
	}, ; 523
	...
	%struct.DSOCacheEntry {
		i64 4200179444, ; hash 0xfa59a6f4, from name: Plugin.FirebaseAuth
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.23_name, ; name: libaot-Plugin.FirebaseAuth.dll.so
		ptr null; void* handle (0x0)
	}, ; 550
